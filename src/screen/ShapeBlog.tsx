  ...
  const blogPosts = [
    {
      category: "Education",
      date: "Nov 4, 2025",
      title: "Minecraft Education: Transforming How Kids Learn Through Play",
      image:
        "https://framerusercontent.com/images/4gVQgMduWWhsREaaP7ZR6gVTqBQ.png?width=800&height=450",
      excerpt:
        "Discover how Minecraft Education Edition is revolutionizing classroom learning by combining creativity with curriculum.",
    },
    {
      category: "Education",
      date: "Oct 29, 2025",
      title: "There are now over 1 million Ocean Heroes!",
      image:
        "https://framerusercontent.com/images/J58AVEIufyb36SzwjGC0Og6Q6yg.png?scale-down-to=512&width=1000&height=1000",
      excerpt:
        "A milestone celebration as our Ocean Heroes sustainability game reaches 1 million engaged learners worldwide.",
    },
    {
      category: "Education",
      date: "Jul 29, 2025",
      title:
        "Students Can Now Restore St. Peter's Basilica Inside Minecraft Education",
      image:
        "https://framerusercontent.com/images/skqVZH5btzgQopDGEFjkeVmI1co.png?scale-down-to=512&width=1000&height=1000",
      excerpt:
        "An immersive historical experience that lets students explore and restore one of the world's most famous architectural marvels.",
    },
    {
      category: "Innovation",
      date: "Jun 15, 2025",
      title:
        "The Future of Educational Gaming: AI-Powered Learning Experiences",
      image:
        "https://framerusercontent.com/images/KuRhSfCb6pVKfz9UhMhKIQl5GhE.png?scale-down-to=512&width=1000&height=1000",
      excerpt:
        "Exploring how artificial intelligence is shaping the next generation of educational games and personalized learning.",
    },
    {
      category: "Sustainability",
      date: "May 22, 2025",
      title: "Climate Change Education Through Interactive Simulations",
      image:
        "https://framerusercontent.com/images/4gVQgMduWWhsREaaP7ZR6gVTqBQ.png?width=800&height=450",
      excerpt:
        "How virtual environments are helping students understand complex environmental challenges and solutions.",
    },
    {
      category: "Technology",
      date: "Apr 18, 2025",
      title: "Building Inclusive Gaming Experiences for All Learners",
      image:
        "https://framerusercontent.com/images/J58AVEIufyb36SzwjGC0Og6Q6yg.png?scale-down-to=512&width=1000&height=1000",
      excerpt:
        "Our approach to creating accessible and inclusive educational games that work for students of all abilities.",
    },
  ];
    ...
    <View style={{ flex: 1 }}>
      <ScrollView style={styles.page}>
        ...
        <View style={{ marginTop: SIZES.h2, alignItems: "center" }}>
          ...
          >
            Catch up with the latest news and insights from Shapescape and the
            educational videogame space.
          </Text>
        </View>
        ...
        <View style={{ marginTop: SIZES.h1 }}>
          {blogPosts.map((post, index) => (
            <TouchableOpacity key={index} style={styles.blogPostCard}>
              <Image
              ...
              <View style={styles.blogPostContent}>
                ...
                <Text style={styles.blogPostExcerpt}>{post.excerpt}</Text>
